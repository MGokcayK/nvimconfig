...
vim.keymap.set('n', '<Space><UP>', "<C-W><UP>", { noremap = true, desc = 'horizontal split window' })
vim.keymap.set('n', '<Space><DOWN>', "<C-W><DOWN>", { noremap = true, desc = 'horizontal split window' })
vim.keymap.set('n', '<Space><LEFT>', "<C-W><LEFT>", { noremap = true, desc = 'horizontal split window' })
vim.keymap.set('n', '<Space><RIGHT>', "<C-W><RIGHT>", { noremap = true, desc = 'horizontal split window' })
